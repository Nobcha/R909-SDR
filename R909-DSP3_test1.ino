// R909-DSP3 radio V1
//  1. starting mode = SCAN   L#177
//  2. RSSI sencing time 1000mS L#122
//  3. Dispay refresh period L#804, L#123 1000mS
// Base on R909-SDR-OLED radio V3.2  
//  "H:\nob\AIRBAND RECEIVER\9H5BM_5351\R909_PANEL\R909-SDR_1\R909-SDR-OLED_test\R909-SDR-OLED_test2"
// --=----=----=----=----=----=----=----=----=----=----=----=----
// 2024.02.08  V3.2  87% 42%
//  remaining issues
//  1.FM/AM volume level, 
//
...
// --=----=----=----=----=----=----=----=----=----=----=----=----
//
#define Time_elapsedRSSI 1000  // RSSI check period mS
#define Time_elapsedDISP 1000  // Display refresh period mS
...
volatile int mode = SCAN;        // current mode 
...
void loop() {
  ...
  blink(700, 900);      // Blinking for monitor LED and FUNC display on OLED
...
//    FUNC_Disp(funcdisp);
    ...
    layout();
    display.clearDisplay();    
    Timer_DISP_REF = Time_elapsedDISP;    // Display every Time_elapsedDISP mS
  }
